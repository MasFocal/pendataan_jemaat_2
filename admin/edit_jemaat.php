...
<body>
    <?php 
        ...
        $query1=mysqli_query($konek_db, "SELECT * FROM jemaat WHERE nik ='".$_GET['id']."'");
        ...
        if(isset($_POST['simpan'])){
            ...
            $query="UPDATE `jemaat` SET
                ...
                `password`='$password' WHERE nik='".$_GET['id']."'
            ";                       
            ...
            if ($result) {
                ...
                echo ("<script>
                    ...
                    window.location.href='edit_jemaat.php';
                </script>");
                exit();
            } 
        }
            ...
            <table id="tb-list">
                <div class="password">
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="password" id="input-password" value="<?php echo $data['password'] ?>" required><button type="button" id="lihat-password">Lihat</button></td>
                    </tr>
                </div>
            </table>
