...
<body>
    ...
    <div class="body-content">
        <h1>Data SIDI</h1>
        <a id="-" href="tambah_sidi.php"><button id="btn-tambah">TAMBAH DATA</button></a>
        ...
        <div class="tabel">
            <table id="tb-data">
                ...
                $where = '';
                    ...
                    $query=mysqli_query($konek_db, "SELECT * FROM sidi INNER JOIN jemaat ON sidi.nik = jemaat.nik".$where);
                    $id = 0;
                    ...
                    <tr id="tb-tr">
                        <?php
                            ...
                            echo "
                                ...
                                <td id='tb-td'>".$data["no_surat_sidi"]."</td>
                                <td id='tb-td'>
                                    <div class='action'>
