...
<body>
    <?php 
        ...
        if(isset($_POST['simpan'])) {
            ...
            $cekNIK = mysqli_query($konek_db, "SELECT * FROM `sidi` WHERE `nik` = '$nik'");
    ...
    <div class="body-content">
        ...
        <form action="" method="POST">
            <table id="tb-list">
                ...
                <tr>
                    <td><label id="label-input">No Surat SIDI :</label></td>
                    <td><input type="text" name="no_surat_sidi" id="input-admin" required></td>
                </tr>
                <tr>
                    <td><label id="label-input">Tempat Baptis :</label></td>
                    <td><input type="text" name="tempat_sidi" id="input-admin" required></td>
                </tr>
                <tr>
                    <td><label id="label-input">Tanggal Baptis :</label></td>
                    <td><input type="date" name="tanggal_sidi" id="input-admin" required></td>
                </tr>
                <tr>
