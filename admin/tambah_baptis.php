...
<head>
    ...
    <title>Tambah Data Baptis</title>
</head>
<body>
    <?php 
        ...
        if(isset($_POST['simpan'])) {
            ...
            $cekNIK = mysqli_query($konek_db, "SELECT * FROM `baptis` WHERE `nik` = '$nik'");
        ...
        <form action="" method="POST">
            <table id="tb-list">
                ...
                <tr>
                    ...
                    <td><input type="text" name="no_surat_baptis" id="input-admin" required></td>
                </tr>
                <tr>
                    <td><label id="label-input">Tempat Baptis :</label></td>
                    <td><input type="text" name="tempat_baptis" id="input-admin" required></td>
                </tr>
                <tr>
                    <td><label id="label-input">Tanggal Baptis :</label></td>
                    <td><input type="date" name="tanggal_baptis" id="input-admin" required></td>
                </tr>
                <tr>
