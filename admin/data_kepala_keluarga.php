...
<body>
    <?php 
        ...
        if(isset($_POST["detail"])) {
            $id = $_POST["id_jemaat"];
            header("location: detail_kepala_keluarga.php?id=".$id);
        }
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['hapus']) == 'yes') {
            $id = $_POST['id_jemaat'];
            $result = mysqli_query($konek_db, "DELETE FROM kepala_keluarga WHERE nik='$id'");
    
            if ($result) {
                echo "<script type='text/javascript'>
                    alert('Data kepala keluarga Berhasil Dihapus');
    ...
    <div class="body-content">
        ...
        <a id="-" href="tambah_kepala_keluarga.php"><button id="btn-tambah">TAMBAH DATA</button></a>
        ...
        <div class="tabel">
            <table id="tb-data">
                <tr id="tb-tr">
                    <th id="tb-th">No</th>
                    <th id="tb-th">Nama Kepala Keluarga</th>
                    <th id="tb-th">Blok</th>
                ...
                $where = '';
                    ...
                    $query=mysqli_query($konek_db, "SELECT * FROM kepala_keluarga INNER JOIN jemaat ON kepala_keluarga.nik = jemaat.nik".$where);
                    $id = 0;
