...
<body>
    <?php 
        ...
        if(isset($_POST["detail"])) {
            $id = $_POST["id_jemaat"];
            header("location: detail_baptis.php?id=".$id);
        }
        if(isset($_POST["edit"])) {
            $id = $_POST["id_jemaat"];
            header("location: edit_baptis.php?id=".$id);
        }
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['hapus']) == 'yes') {
            $id = $_POST['id_jemaat'];
            $result = mysqli_query($konek_db, "DELETE FROM baptis WHERE nik='$id'");
    ...
    <div class="body-content">
        <h1>Data Baptis</h1>
        <a id="-" href="tambah_baptis.php"><button id="btn-tambah">TAMBAH DATA</button></a>
        ...
        <div class="tabel">
            <table id="tb-data">
                ...
                $where = '';
                    ...
                    $query=mysqli_query($konek_db, "SELECT * FROM baptis INNER JOIN jemaat ON baptis.nik = jemaat.nik".$where);
                    $id = 0;
                    ...
                    <tr id="tb-tr">
                        <?php
                            ...
                            echo "
                                ...
                                <td id='tb-td'>".$data["no_surat_baptis"]."</td>
                                <td id='tb-td'>
                                    <div class='action'>
